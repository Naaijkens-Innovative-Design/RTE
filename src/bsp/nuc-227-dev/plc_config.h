...
#define DBG_USART_PERIPH RCC_USART2
#define DBG_USART_VECTOR NVIC_USART2_IRQ
#define DBG_USART_ISR usart2_isr

#define DBG_USART_TX_PORT GPIOA
#define DBG_USART_RX_PORT GPIOA

#define DBG_USART_TX_PIN GPIO3
#define DBG_USART_RX_PIN GPIO2
...
* PLC Inputs
*/
#define PLC_I1_PERIPH RCC_GPIOA
...
#define PLC_I6_PIN GPIO7

#define PLC_I7_PERIPH RCC_GPIOD
#define PLC_I7_PORT GPIOD
#define PLC_I7_PIN GPIO8

#define PLC_I8_PERIPH RCC_GPIOD
#define PLC_I8_PORT GPIOD
#define PLC_I8_PIN GPIO9

/*
* PLC Outputs
*/
#define PLC_O1_PERIPH RCC_GPIOD
#define PLC_O1_PORT GPIOD
#define PLC_O1_PIN GPIO15
